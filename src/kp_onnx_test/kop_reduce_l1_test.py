...
import numpy as np
import time
from kp_onnx_ssbo.kop_reduce_l1 import ReduceL1Op
...
def np_reducel1(data, axes=None, keepdims=True, noop_with_empty_axes=False):
...
np_out = np_reducel1(x, keepdims=True, noop_with_empty_axes=False)
print("Numpy:", time.time() - start_time, "seconds")

start_time = time.time()
kp_out = reducel1_op.run(x)[0]
print(f"{reducel1_op}: ", time.time() - start_time, "seconds")
...
start_time = time.time()
np_out = np_reducel1(x, keepdims=False, noop_with_empty_axes=False)
print("Numpy:", time.time() - start_time, "seconds")

start_time = time.time()
reducel1_op.keepdims = False
reducel1_op.noop_with_empty_axes = False
kp_out = reducel1_op.run(x)[0]
print(f"{reducel1_op}: ", time.time() - start_time, "seconds")
...
start_time = time.time()
np_out = np_reducel1(x, keepdims=True, noop_with_empty_axes=True)
print("Numpy:", time.time() - start_time, "seconds")

start_time = time.time()
reducel1_op.keepdims = True
reducel1_op.noop_with_empty_axes = True
kp_out = reducel1_op.run(x, None)[0]
print(f"{reducel1_op}: ", time.time() - start_time, "seconds")
...
start_time = time.time()
np_out = np_reducel1(x, keepdims=False, noop_with_empty_axes=True)
print("Numpy:", time.time() - start_time, "seconds")
...
start_time = time.time()
np_out = np_reducel1(x, axes, keepdims=True, noop_with_empty_axes=False)
print("Numpy:", time.time() - start_time, "seconds")

start_time = time.time()
reducel1_op.keepdims = True
reducel1_op.noop_with_empty_axes = False
kp_out = reducel1_op.run(x, axes)[0]
print(f"{reducel1_op}: ", time.time() - start_time, "seconds")
...
axes = (0, )
start_time = time.time()
np_out = np_reducel1(x, axes, keepdims=False, noop_with_empty_axes=False)
print("Numpy:", time.time() - start_time, "seconds")
