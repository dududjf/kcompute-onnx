...
import numpy as np
import time
from kp_onnx_ssbo.kop_reduce_min import ReduceMinOp
...
def np_min(data, axes=None, keepdims=True, noop_with_empty_axes=False):
    ...
    if data.size == 0:
        ...
        return reduce_constant(data, maxvalue, axes, keepdims)
...
np_out = np_min(x, keepdims=True, noop_with_empty_axes=False)
print("Numpy:", time.time() - start_time, "seconds")

start_time = time.time()
reduce_min_op.keepdims = True
reduce_min_op.noop_with_empty_axes = False
kp_out = reduce_min_op.run(x)[0]
print(f"{reduce_min_op}: ", time.time() - start_time, "seconds")
...
start_time = time.time()
np_out = np_min(x, keepdims=False, noop_with_empty_axes=False)
print("Numpy:", time.time() - start_time, "seconds")

start_time = time.time()
reduce_min_op.keepdims = False
reduce_min_op.noop_with_empty_axes = False
kp_out = reduce_min_op.run(x)[0]
print(f"{reduce_min_op}: ", time.time() - start_time, "seconds")
...
start_time = time.time()
np_out = np_min(x, keepdims=True, noop_with_empty_axes=True)
print("Numpy:", time.time() - start_time, "seconds")

start_time = time.time()
reduce_min_op.keepdims = True
reduce_min_op.noop_with_empty_axes = True
kp_out = reduce_min_op.run(x, None)[0]
print(f"{reduce_min_op}:", time.time() - start_time, "seconds")
...
start_time = time.time()
np_out = np_min(x, keepdims=False, noop_with_empty_axes=True)
print("Numpy:", time.time() - start_time, "seconds")
...
start_time = time.time()
np_out = np_min(x, axes, keepdims=True, noop_with_empty_axes=False)
print("Numpy:", time.time() - start_time, "seconds")

start_time = time.time()
reduce_min_op.keepdims = True
reduce_min_op.noop_with_empty_axes = False
kp_out = reduce_min_op.run(x, axes)[0]
print(f"{reduce_min_op}: ", time.time() - start_time, "seconds")
...
axes = (0, )
start_time = time.time()
np_out = np_min(x, axes, keepdims=False, noop_with_empty_axes=False)
print("Numpy:", time.time() - start_time, "seconds")
